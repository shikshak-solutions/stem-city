    ...
    return(
        <section>
            <div  className="policy-container">
                ...
                <h1>Welcome to Learnocean Technology Pvt. Ltd.</h1>

                <p>1. This document is an electronic record in terms of Information Technology Act, 2000 and rules
                ...
                <p>2. This document is published in accordance with the provisions of Rule 3 (1) of the Information
                    Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and
                    regulations, privacy policy and Terms of Use for access or usage of domain name <strong>stemcity.in</strong>
                    ('Website'), including the related mobile site and mobile application (hereinafter referred to as
                    'Platform').</p>

                <p>3. The Platform is owned by <strong>LEARNOCEAN TECHNOLOGY PVT LTD,</strong>  a company incorporated under the
                    Companies Act, 1956 with its registered office at Suncity Avenue 76 Gurugram, Haryana (hereinafter referred to as
                    ‘Platform Owner’, 'we', 'us', 'our')..</p>

                <p>4. Your use of the Platform and services and tools are governed by the following terms and
                ...
                <p>5. For the purpose of these Terms of Use, wherever the context so requires ‘you’, 'your' or ‘user’ shall
                    mean any natural or legal person who has agreed to become a user/buyer on the Platform..</p>

                <p>6. ACCESSING, BROWSING OR OTHERWISE USING THE PLATFORM INDICATES YOUR
                    AGREEMENT TO ALL THE TERMS AND CONDITIONS UNDER THESE TERMS OF USE,
                    SO PLEASE READ THE TERMS OF USE CAREFULLY BEFORE PROCEEDING..</p>

                <p>7. The use of Platform and/or availing of our Services is subject to the following Terms of Use:</p>
                <ul>
                    <li><strong>(i).</strong> To access and use the Services, you agree to provide true, accurate and complete information
                    ...
                    <li><strong>(ii).</strong> Neither we nor any third parties provide any warranty or guarantee as to the accuracy,
                    ...
                    <li><strong>(iii).</strong> Your use of our Services and the Platform is solely and entirely at your own risk and
                    ...
                    <li><strong>(iv).</strong> The contents of the Platform and the Services are proprietary to us and are licensed to us.
                    ...
                    <li><strong>(v).</strong> You acknowledge that unauthorized use of the Platform and/or the Services may lead to
                        action against you as per these Terms of Use and/or applicable laws.</li>
                    <li><strong>(vi).</strong> You agree to pay us the charges associated with availing the Services.</li>
                    <li><strong>(vii).</strong> You agree not to use the Platform and/ or Services for any purpose that is unlawful, illegal or
                        forbidden by these Terms, or Indian or local laws that might apply to you.</li>
                    <li><strong>(viii).</strong> You agree and acknowledge that website and the Services may contain links to other third
                    ...
                    <li><strong>(ix).</strong> You understand that upon initiating a transaction for availing the Services you are entering
                        into a legally binding and enforceable contract with the Platform Owner for the Services.</li>
                    <li><strong>(x).</strong> You shall indemnify and hold harmless Platform Owner, its affiliates, group companies (as
                    ...
                    <li><strong>(xi).</strong> Notwithstanding anything contained in these Terms of Use, the parties shall not be liable for
                        any failure to perform an obligation under these Terms if performance is prevented or
                        delayed by a force majeure event.</li>
                    <li><strong>(xii).</strong> These Terms and any dispute or claim relating to it, or its enforceability, shall be governed
                        by and construed in accordance with the laws of India.</li>
                    <li><strong>(xiii).</strong> All disputes arising out of or in connection with these Terms shall be subject to the exclusive
                        jurisdiction of the courts in Gurugram and Haryana.</li>
                    <li><strong>(xiv).</strong> All concerns or communications relating to these Terms must be communicated to us using

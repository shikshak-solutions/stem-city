    ...
    return(
        <section>
            <div  className="policy-container">
                ...
                <p>This Privacy Policy describes how <strong>LEARNOCEAN TECHNOLOGY PVT LTD,</strong> and its affiliates (collectively "
                    <strong>LEARNOCEAN TECHNOLOGY PVT LTD,</strong> we, our, us") collect, use, share, protect or otherwise process your
                    information/ personal data through our website <strong>stemcity.in</strong> (hereinafter referred to as <strong>Platform</strong>). Please
                ...
                <p><strong>Collection-</strong>We collect your personal data when you use our Platform, services or otherwise interact with
                    ...
                    any information. If you receive an email, a call from a person/association claiming to be <strong>LEARNOCEAN TECHNOLOGY PVT LTD,</strong> seeking any personal data like debit/credit card PIN, net-banking or mobile
                    banking password, we request you to never provide such information. If you have already revealed such
                    information, report it immediately to an appropriate law enforcement agency.</p>

                <p><strong>Usage-</strong> We use personal data to provide the services you request. To the extent we use your personal data
                    ...
                    these products/services may be affected in the event permission is not provided to us.</p>

                <p><strong>Sharing-</strong> We may share your personal data internally within our group entities, our other corporate
                ...
                <p><strong>Security Precautions-</strong> To protect your personal data from unauthorised access or disclosure, loss or
                ...
                <p><strong>Data Deletion and Retention-</strong> You have an option to delete your account by visiting your profile and
                ...
                <p><strong>Your Rights-</strong> You may access, rectify, and update your personal data directly through the functionalities
                    provided on the Platform.</p>
                <p><strong>Consent- </strong> By visiting our Platform or by providing your information, you consent to the collection, use,
                ...
                <p><strong>Changes to this Privacy Policy- </strong> Please check our Privacy Policy periodically for changes. We may
                ...
                {/*    <p>Name</p>*/}
                {/*    <p>Designation</p>*/}
                {/*    <p>LEARNOCEAN TECHNOLOGY PVT LTD</p>*/}
                {/*    <p>B8-505, Adjacent to White Land, Kherki Daula Road, Gurugram, Haryana </p>*/}
                <h2>Contact Us:</h2>
                <p>Phone : +91 9599185057</p>
                <p>Time: Monday - Saturday(10:00 - 18:00)</p>
                <p>LEARNOCEAN TECHNOLOGY PVT LTD</p>
                <p>B8-505, Adjacent to White Land, Kherki Daula Road, Gurugram, Haryana </p>
